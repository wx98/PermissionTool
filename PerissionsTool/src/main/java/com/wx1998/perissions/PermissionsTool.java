...
public class PermissionsTool extends Activity {
     ...
     * @param callBack
     */
    public PermissionsTool setCallback(RequestPermissionsResultCallBack callBack){
     ...
     * @return
     */
    public PermissionsTool PermissionUtil(Activity activity){
        mActivity = activity;
        return permissionsTool;
    }

    public PermissionsTool PermissionUtil(Fragment mFragment){
     ...
     * 单例模式获取本类实例
     */
    private volatile static PermissionsTool permissionsTool;
    public static PermissionsTool getInstance(Activity activity) {
        mActivity = activity;
        if (permissionsTool == null) {
            synchronized (PermissionsTool.class) {
                if (permissionsTool == null) {
                    permissionsTool = new PermissionsTool();
                }
            }
        }
        return permissionsTool;
     ...
     * @return  本类实例
     */
    public PermissionsTool setPermissionList(String... PermissionList){
        LogUtil.e("===============根据参数设置权限表=====================");
        //循环将参数列表的内容添加置权限表
     ...
     * @return 本类实例
     */
    public PermissionsTool getPermission(Fragment mFragment){
        mActivity = mFragment.getActivity();
        getPermission();
        return permissionsTool;
    }
     ...
     * @return 本类实例
     */
    public PermissionsTool getPermission(){
     ...
     * @return
     */
    public static PermissionsTool LogSwitch(boolean mark){
